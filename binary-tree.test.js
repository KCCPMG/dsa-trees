...
describe("maxSum", function() {
  ...
  it("handles my custom test", function(){
    let root = new BinaryTreeNode(10);
    root.left = new BinaryTreeNode(0, left=new BinaryTreeNode(0), right=new BinaryTreeNode(0));
    root.right = new BinaryTreeNode(-10, left=new BinaryTreeNode(100), right=new BinaryTreeNode(101));

    let tree = new BinaryTree(root);
    expect(tree.maxSum()).toBe(191);
  })
});
